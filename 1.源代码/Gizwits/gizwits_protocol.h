...
* @{
*/
#define PRODUCT_KEY "c95f19968fac4eef8bf8ea3d64a10ede"
/**@} */
/**@name Product Secret  
* @{
*/
#define PRODUCT_SECRET "ebe9f2a827b24f3a8404307872ab1f20"
...
*/
#define LED_LEN                           1
#define waterPump_LEN                           1
#define smogAlarm_LEN                           1
#define methaneAlarm_LEN                           1
#define flameAlarm_LEN                           1
#define fan_LEN                           1
#define people_LEN                           1
#define flame_LEN                           1
#define valve_LEN                           1
...
#define tempValue_ADDITION                      0
#define tempValue_MIN                           0
#define tempValue_MAX                           99
#define tempValue_LEN                           1
#define flameValue_RATIO                         1
#define flameValue_ADDITION                      0
#define flameValue_MIN                           0
#define flameValue_MAX                           99
#define flameValue_LEN                           1
#define smog_RATIO                         1
#define smog_ADDITION                      0
#define smog_MIN                           0
#define smog_MAX                           500
#define smog_LEN                           2
#define methane_RATIO                         1
#define methane_ADDITION                      0
#define methane_MIN                           0
#define methane_MAX                           500
#define methane_LEN                           2
#define smogValue_RATIO                         1
#define smogValue_ADDITION                      0
#define smogValue_MIN                           0
#define smogValue_MAX                           500
#define smogValue_LEN                           2
#define methaneValue_RATIO                         1
#define methaneValue_ADDITION                      0
#define methaneValue_MIN                           0
#define methaneValue_MAX                           500
#define methaneValue_LEN                           2
...
typedef struct {
    ...
    bool valuewaterPump;
    bool valuesmogAlarm;
    bool valuemethaneAlarm;
    bool valueflameAlarm;
    bool valuefan;
    uint32_t valuepeople;
    uint32_t valueflame;
    uint32_t valuevalve;
    uint32_t valuemode;
    ...
    uint32_t valueflameValue;
    uint32_t valuesmog;
    uint32_t valuemethane;
    uint32_t valuesmogValue;
    uint32_t valuemethaneValue;
} dataPoint_t;

/** User Area Device State Structure */
typedef struct {
    uint8_t flagLED:1;
    uint8_t flagwaterPump:1;
    uint8_t flagsmogAlarm:1;
    uint8_t flagmethaneAlarm:1;
    uint8_t flagflameAlarm:1;
    uint8_t flagfan:1;
    uint8_t flagpeople:1;
    uint8_t flagflame:1;
    uint8_t flagvalve:1;
    uint8_t flagmode:1;
    ...
    uint8_t flagflameValue:1;
    uint8_t flagsmog:1;
    uint8_t flagmethane:1;
    uint8_t flagsmogValue:1;
    uint8_t flagmethaneValue:1;
} dataPointFlags_t;
...
typedef struct {
    ...
    uint8_t valueflameValue;
    uint16_t valuesmog;
    uint16_t valuemethane;
    uint16_t valuesmogValue;
    uint16_t valuemethaneValue;
} devStatus_t;
